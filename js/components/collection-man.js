...
function renderCards(data) {
    data.forEach(el => {
        if (el.sex === 'man') {
            cardsHTML('.catalog-list--man', el, 'catalog-list__item', 'catalog-list__wrapper', 'catalog-list__img', 'catalog-list__description', 'catalog-list__price', 'catalog-list__button')
        }
    });
